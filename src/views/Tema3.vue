...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4
          ...
          .tarjeta.BG033
            .p-4
              .row.justify-content-center.mb-3
                .col-auto
                  .py-2.px-3
                    p.mb-0 #[b A. Conocimiento tácito]
      ...
      .col-10.col-md-6.col-lg-5(data-aos="fade-left")
        .tarjeta-avatar
          ...
          .tarjeta.BG033
            .p-4
              .row.justify-content-center.mb-3
                .col-auto
                  .py-2.px-3
                    p.mb-0 #[b B. Conocimiento explícito]
    ...
    .BMG1.px-5
      ...
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-10
          .titulo-sexto.color-acento-contenido.mb-3
            h5 Tabla 5.
            span Lecciones aprendidas recurrentes en proyectos de desarrollo de #[i software]
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-10
          .tabla-a.color-acento-contenido
            table
    ...
    .row.justify-content-center
      .col-lg-10
        figure
          img(src='@/assets/curso/Temas/tema3/img15.png', alt='Ilustración de equipo trabajando en desarrollo de #[i software]')
