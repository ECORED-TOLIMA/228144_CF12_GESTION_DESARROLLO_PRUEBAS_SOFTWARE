  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-lg-3.d-none.d-lg-block
        figure
          img.mx-auto.d-block(src="@/assets/curso/Temas/tema4/img10.svg" alt="Imagen modelo SECI")
    ...
    p.mb-4 A continuación, se presenta un ejemplo aplicado de la Técnica de los 5 Porqués, con el fin de ilustrar su uso práctico en la identificación de la causa raíz de un problema recurrente en proyectos de #[i software] y la definición de una acción correctiva concreta y accionable:
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-4.mb-3.mb-lg-0
        figure
          img.mx-auto.d-block(src="@/assets/curso/Temas/tema4/img13.svg" alt="Imagen modelo SECI")
      .col-lg-8
        .tarjeta.BG03.p-4
          .row.justify-content-center.align-items-center
            .col-lg-11
            ...
            .col-lg-1.d-none.d-lg-block
              figure
                img(src='@/assets/curso/Temas/tema4/img14.svg', width='185', alt='')        

    p.mb-4 Basado en lo anterior, la siguiente tabla contiene acciones aplicadas a ejemplos reales:
    
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3
          h5 Tabla 8.
          span Ejemplos de acciones correctivas en proyectos de #[i software]
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .tabla-a.color-acento-contenido
          table
    ...
    p.mb-4 Las acciones preventivas eliminan causas de no conformidades potenciales, antes de que ocurran. Se basan en análisis de riesgo, lecciones aprendidas de proyectos anteriores y tendencias de indicadores que aún no son críticos, pero muestran deterioro.
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-lg-9.order-1.order-lg-2
        ...
        .cajon.color-primario.p-4
          p.mb-0 Con el fin de clarificar el rol de las acciones de mejoramiento dentro de un plan de mejora, a continuación, se presentan dos tablas de apoyo. La primera compara las acciones correctivas, preventivas y de mejoramiento, según distintas dimensiones clave; mientras que la segunda ilustra ejemplos concretos de acciones preventivas y de mejoramiento aplicadas en contextos reales de proyectos de #[i software]:
            ...
            thead
              tr
                ...
                th
                  ul.lista-ul
                    li
                      i.fas.fa-circle(style="color: #F34846")
                      | Correctiva
                th 
                  ul.lista-ul
                    li
                      i.fas.fa-circle(style="color: #1ED279")
                      | Preventiva
                th 
                  ul.lista-ul
                    li
      ...
      .col-lg-9
        .tarjeta.BG03.p-4
          .row.justify-content-center.align-items-center
            ...
            .col-lg-11
                p.mb-0 Con base en la definición de roles establecida por la matriz RACI, la siguiente tabla muestra la asignación de responsabilidades para las principales actividades del plan de mejora de #[i software]. Esta matriz permite visualizar de manera explícita quién ejecuta, quién responde, a quién se consulta y a quién se informa en cada acción, reduciendo ambigüedades y fortaleciendo la gobernanza del plan:
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3
          h5 Tabla 11.
          span Matriz RACI — Plan de mejora de #[i software]
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .tabla-a.color-acento-contenido
          table
    ...
    p.mb-4 Estados de avance o escala de semáforo, se presenta la siguiente imagen que detalla el estado de cada acción, junto a su criterio y la acción requerida en cada uno:
      ...
      .col-lg-10
        .d-none.d-lg-block
          ImagenInfografica.color-acento-botones
            ...
            .tarjeta.color-secundario.p-3(x="64%" y="16%" numero="+")
              h5 Ejecutada, evidencia disponible, indicador cumplido.
              p.mb-0 Documentar y cerrar. Estandarizar si aplica.

            .tarjeta.color-secundario.p-3(x="64%" y="31%" numero="+")
              h5 Iniciada, dentro del plazo, avance ≥ 50 %
              p.mb-0 Continuar. Verificar recursos disponibles.

            .tarjeta.color-secundario.p-3(x="64%" y="46%" numero="+")
              h5 Avance < 50 % con menos del 30 % del tiempo restante.
              p.mb-0 Escalar al Accountable (A). Revisar plan y recursos.
            
            .tarjeta.color-secundario.p-3(x="64%" y="62%" numero="+")
              h5 Plazo superado sin completar la acción
              p.mb-0 Análisis inmediato. Reprogramar con justificación.
            
            .tarjeta.color-secundario.p-3(x="64%" y="77%" numero="+")
              h5 No viable o el contexto cambió significativamente.
              p.mb-0 Documentar motivo. Evaluar acción alternativa.
        .d-block.d-lg-none
          figure
